    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('lin_id', models.CharField(blank=True, max_length=150, null=True, unique=True)),
                ...
                ('school_type', models.CharField(blank=True, choices=[('day', 'Day'), ('boarding', 'Boarding'), ('bursary', 'Bursary'), ('scholarhip', 'scholarship')], default='day', max_length=150, null=True)),
                ('grade_of_entry', models.CharField(blank=True, choices=[('KIN', 'Kindergarten'), ('BBY', 'Baby'), ('MID', 'Middle'), ('UPP', 'Upper'), ('TOP', 'Top'), ('grade_7', 'Grade 7'), ('grade_6', 'Grade 6'), ('grade_5', 'Grade 5'), ('grade_4', 'Grade 4'), ('grade_3', 'Grade 3'), ('grade_2', 'Grade 2'), ('grade_1', 'Grade 1')], max_length=150, null=True)),
                ('year_of_entry', models.CharField(blank=True, max_length=4, null=True, validators=[django.core.validators.RegexValidator(message='Year must be in YYYY format.', regex='^\\d{4}$')], verbose_name='Year of Entry')),
                ...
                ('father_NIN', models.CharField(blank=True, max_length=200, null=True)),
                ...
                ('mother_NIN', models.CharField(blank=True, max_length=200, null=True)),
