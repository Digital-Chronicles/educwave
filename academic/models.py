...
class SubjectTotalMark(models.Model):
    student = models.ForeignKey('students.Student', on_delete=models.CASCADE, related_name="subject_totals")
    term_exam = models.ForeignKey(TermExamSession, on_delete=models.CASCADE, related_name="subject_totals")
    exam_type = models.ForeignKey(ExamSession, on_delete=models.DO_NOTHING)
    subject = models.ForeignKey(Subject, on_delete=models.CASCADE, related_name="subject_totals")
    grade = models.ForeignKey(Grade, on_delete=models.CASCADE, related_name="subject_totals")
